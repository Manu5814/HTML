let input=document.querySelector('input');  //buscar la etiqueta input y la aloja en var input
let content1=document.querySelector('#bgblue'); //buscar la etiqueta input y la aloja en var input
...
// seccion de addVentListener a cada boton del editor
